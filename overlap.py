...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="overlap")
    parser.add_argument("--anns", default="anns", help="Location of annotation files.")

    parser.add_argument("--images", default="images", help="Location of image files.")
